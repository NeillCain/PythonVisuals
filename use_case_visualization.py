...
# Only add solid bold gridlines for main cell divisions
...
plt.title("Use Case Field Category Mapping with Solid Bold Grid Lines", fontsize=16)
...
plt.tight_layout()
#plt.show()
plt.savefig('use_case_visualization.png')
